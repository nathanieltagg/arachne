/* $Id: canvas.text.js 35 2009-06-01 21:20:12Z fabien.menager $ */
...
(function(){
  ...
  function initialize(){
    var libFileName = 'libs/canvas.text.js',
  ...
  ctxt.getFace = function(family, weight, style) {
    ...
    else throw 'Unable to load the font ['+family+' '+weight+' '+style+'] from '+url;
    return false;
  };
