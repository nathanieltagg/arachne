...
$query = "select * from tscans $sel order by run asc, subrun asc, snarl asc, slice asc, modification_date desc";
if(defined(param('bestonly'))) {
  ...
  $query =  "select tscans.* "
          . " from ( "
          . "       select  user_name,det,recoVer,run,subrun,snarl,slice,max(modification_date) as recdate "
          . "       from tscans "
          . "      group by user_name,det,recoVer,run,subrun,snarl,slice "
          . "   ) as t1 "
          . " inner join tscans "
